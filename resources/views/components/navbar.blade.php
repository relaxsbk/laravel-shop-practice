<nav class="navbar navbar-expand-lg bg-body-tertiary ">
    <div class="container">
        <a class="navbar-brand h-5 " href="/">
            <img src="{{asset('storage/static/header/logo-name.svg')}}" alt="logo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="btn btn-primary me-3 d-flex align-items-center" aria-current="page" href="#" style="white-space: nowrap;">
